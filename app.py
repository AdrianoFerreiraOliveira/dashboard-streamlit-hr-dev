...
# Mapa com a localização dos funcionários
st.header('Localização dos funcionários')
fig_mapa = px.choropleth(df_filtrado, locations='País', color='Salário', 
                        color_continuous_scale=px.colors.sequential.Plasma, projection='natural earth')
fig_mapa.update_layout(title='Localização dos funcionários', margin=dict(l=0, r=0, t=30, b=0))
